    ...
    return (
        <div name='support' className='w-full mt-24'>
            ...
            <div className='w-full h-[700px] bg-slate-900/90 absolute'>
                <img src={supportImg} alt='/' className='object-cover w-full h-full mix-blend-overlay' />
            </div>
            <div className='max-w-[1240px] mx-auto text-white relative'>
                <div className='px-4 py-12'>
                    ...
                    <p className='py-4 text-3xl text-slate-300'>There are many variations of passages of Lorem Ipsum available,</p>
                </div>
                ...
                <div className='grid grid-cols-1 px-4 pt-12 text-black lg:grid-cols-3 gap-x-8 gap-y-16 sm:pt-20'>
                    ...
                    <div className='bg-white shadow-2xl rounded-xl'>
                        <div className='p-8'>
                            ...
                            <p className='text-xl text-gray-600'>but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                        </div>
